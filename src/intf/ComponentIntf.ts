 ...
 * @class ComponentIntf
 */
export abstract class ComponentIntf extends ComponentInstanceMethods
  implements WechatMiniprogram.Component.OtherOption, WechatMiniprogram.Component.Lifetimes {
  lifetimes: Partial<{
    created(): void;
    attached(): void;
    ready(): void;
